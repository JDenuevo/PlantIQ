    ...
    <div class="container-fluid">
      <div class="card w-100">
        <div class="card-body p-4">
          <div class="d-flex">
            <h5 class="card-title fw-semibold mb-4">Registered Accounts</h5>
            ...
            <table class="table text-nowrap mb-0 text-center">
              ...
              <tbody>
                   <?php
                    ...
                    $sql = "SELECT * FROM plantiq_login WHERE type = 0 LIMIT $limit OFFSET $offset";
                    if ($rs = $conn->query($sql)) {
                        ...
                        while ($row = $rs->fetch_assoc()) {
                            ...
                            <tr class="text-center">
                              ...
                              <td class="border-bottom-0">
                                  <h6 class="fw-semibold mb-0"><?php echo $row['fullname']; ?></h6>
                              </td>
                               <td class="border-bottom-0">
             ...
             <?php
            // Pagination links
            $sql = "SELECT COUNT(*) AS total FROM plantiq_login WHERE type = 0";
